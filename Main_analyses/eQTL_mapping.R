...
## Load SNP positions
snpspos = read.table(paste0("Inputs/SNP_genotypes/SNP_positions.txt"),header = TRUE, stringsAsFactors = FALSE)
## Load genotype info for SNPs
gtypes = read.table(paste0("Inputs/SNP_genotypes/SNP_genotypes.txt"),header = TRUE, stringsAsFactors = FALSE)
...
## Save files.
snps_positions_file_name="/Inputs/SNP_genotypes/SNP_positions.txt"
gene_positions_file_name=paste0("/Inputs/positions/", data, "_positions.txt")
...
rsIDs <- read.table("Inputs/rsIDs.for.matrixeqtl.txt")
