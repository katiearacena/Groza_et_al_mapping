...
METAS=c("ATACseq","ATACseq","H3K27ac", "H3K27ac", "H3K4me1", "H3K4me1")
DATA_TYPES=c("graph_ATACseq","ref_ATACseq","graph_H3K27ac", "ref_H3K27ac", "graph_H3K4me1", "ref_H3K4me1")
...
for (i in 1:length(DATA_TYPES)){
  ...
  #Load metadata
  meta_data = read.table(paste0("Inputs/metadata/", meta, "_metadata.txt"))
  #Load read counts (row 1 as rownames)
  reads = read.table(paste0("Inputs/counts/", data, "_counts.tsv"), header=TRUE, row.names=1)
